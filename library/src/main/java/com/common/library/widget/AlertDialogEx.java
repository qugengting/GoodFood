...
public class AlertDialogEx extends Dialog {
    ...
    public static class Builder {
         ...
         * @return
         */
        public Builder setItems(String[] items, DialogInterface.OnClickListener icl) {
            this.items = items;
            this.iclItems = icl;
            return this;
        }
         ...
         * @return
         */
        public Builder setPositiveButton(String name, DialogInterface.OnClickListener cl, boolean closeOnClick) {
        ...
        public Builder setPositiveButton(int id, DialogInterface.OnClickListener cl) {
            return setPositiveButton(context.getString(id), cl);
        }

        public Builder setPositiveButton(String name, DialogInterface.OnClickListener cl) {
         ...
         * @return
         */
        public Builder setNegativeButton(String name, DialogInterface.OnClickListener cl, boolean closeOnClick) {
        ...
        public Builder setNegativeButton(int id, DialogInterface.OnClickListener cl) {
            return setNegativeButton(context.getString(id), cl);
        }

        public Builder setNegativeButton(String name, DialogInterface.OnClickListener cl) {
