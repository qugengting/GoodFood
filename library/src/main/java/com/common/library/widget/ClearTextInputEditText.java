...
public class ClearTextInputEditText extends TextInputEditText implements OnFocusChangeListener, TextWatcher {
    /**
     * 删除按钮的引用
     */
    ...
    public ClearTextInputEditText(Context context, AttributeSet attrs, int defStyle) {
