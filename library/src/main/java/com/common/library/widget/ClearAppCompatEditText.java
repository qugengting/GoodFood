...
public class ClearAppCompatEditText extends AppCompatEditText implements OnFocusChangeListener, TextWatcher {
    /**
     * 删除按钮的引用
     */
    ...
    public ClearAppCompatEditText(Context context, AttributeSet attrs, int defStyle) {
