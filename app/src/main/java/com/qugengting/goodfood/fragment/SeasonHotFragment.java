...
public class SeasonHotFragment extends BaseFragment {
    @BindView(R.id.lv_season_hot)
    PullableListView listView;
    @BindView(R.id.refresh_view_season_hot)
    ...
    private static final String DEFAULT_MAIN_URL = "http://home.meishichina.com/show-top-type-recipe-order-quarter.html";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (view == null) {
            view = inflater.inflate(R.layout.fragment_season_hot, container, false);
            unbinder = ButterKnife.bind(this, view);
            listView.setCanPullDown(false);
            adapter = new WeekSelectionAdapter(getActivity(), list);
            listView.setAdapter(adapter);
            ptrl.setOnRefreshListener(new SeasonHotFragment.MyRefreshListener());
            start(null);
        }
        return view;
    }
            ...
            public void call(Subscriber<? super String> subscriber) {
                ...
                .subscribe(new Subscriber<String>() {
                    ...
                    public void onError(Throwable e) {
                        ...
                        Utils.makeText(SeasonHotFragment.this.getActivity(), "网络错误");
                    }
